...
namespace Cronny
{
    public class CronExpression
    {
        ...
        protected CronExpression SetList(IEnumerable<int> values, CronExpressionParameter paramType)
        {
        ...
        public CronExpression SetMinute(IEnumerable<int> minute) => SetList(minute, CronExpressionParameter.Minute);
        ...
        public CronExpression SetHour(IEnumerable<int> hour) => SetList(hour, CronExpressionParameter.Hour);
        ...
        public CronExpression SetDay(IEnumerable<int> day) => SetList(day, CronExpressionParameter.Day);
        ...
        public CronExpression SetMonth(IEnumerable<int> day) => SetList(day, CronExpressionParameter.Month);
        ...
        public CronExpression SetDayOfWeek(IEnumerable<int> day) => SetList(day, CronExpressionParameter.DayOfWeek);
